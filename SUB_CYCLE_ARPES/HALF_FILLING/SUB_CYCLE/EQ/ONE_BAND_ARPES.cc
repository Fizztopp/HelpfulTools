...
// Peierls driving
#define w_peierls      0.004            // ->1 THZ                      // Frequency of Applied Field (in eV)
#define Ax_peierls     0.0            // ->1 MV/cm                      // Amplitude of Applied Field in x-direction
//#define SIGMA        194.0
...
#define timesteps 1e2                                                   // dt = 2.*M_PI/omega/double(timesteps)                                            

// Tr-ARPES
// probe pulse
#define starttime 0.0 
#define endtime   1216.0 //- > 800 fs
#define TIMESTEPS 1e3                                                   // # of timesteps used for G<(t,t') -> timesteps/TIMESTEPS should be int!
#define T_PROBE   403.0   //- > 200 fs                                        		    // delay
