...
file_EDC = open('DATA/IPHOTO10fs.txt','r')
EDC_10 = np.loadtxt(file_EDC)
file_EDC.close()
file_EDC = open('DATA/IPHOTO20fs.txt','r')
EDC_20 = np.loadtxt(file_EDC)
file_EDC.close()
file_EDC = open('DATA/IPHOTO40fs.txt','r')
EDC_40 = np.loadtxt(file_EDC)
file_EDC.close()
file_EDC = open('DATA/IPHOTO60fs.txt','r')
EDC_60 = np.loadtxt(file_EDC)
file_EDC.close()
file_EDC = open('DATA/IPHOTO80fs.txt','r')
EDC_80 = np.loadtxt(file_EDC)
file_EDC.close()
file_EDC = open('DATA/IPHOTO100fs.txt','r')
